...
public final class ValidateCodeTest extends BaseTest {
	 ...
	 */
	@Test
	public void testValidateCodeV1() {
		try {
			// 页面/服务 地址
			String url = "/validate/code/v1";
			// 请求构建器
			// get 方法
			...
			String filePath = ProjectUtil.getAbsolutePath("/doc/download/validate-code_01.png", true);
			...
			log.error("testValidateCodeV1 =====> ", e);
		}
	}	
	 ...
	 */
	@Test
	public void testValidateCodeV2() {
		try {
			// 页面/服务 地址
			String url = "/validate/code/v2";
			// 请求构建器
			// get 方法
			//MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get(url);
			// post 方法
			...
			// 响应对象
			MockHttpServletResponse response = mvcResult.getResponse();
			String filePath = ProjectUtil.getAbsolutePath("/doc/download/validate-code_02.png", true);
			File file = new File(filePath);
			OutputStream outputStream = new FileOutputStream(file);
			//OutputStream outputStream = new FileOutputStream(ProjectUtil.getAbsolutePath("/doc/download/t.png", true));
			//outputStream.write(response.getContentAsByteArray());
			...
			log.error("testValidateCodeV2 =====> ", e);
		}
	}		
