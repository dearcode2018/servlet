...
public final class ChatClient
{
	...
	/**
	 ...
	 Map<String, Set<ChatClient>> key-房间编号，value 是在该房间的所有客户端
	...
	{
		System.out.println("ChatClient.incoming()");
	...
	{
		for (ChatClient client : connections)
		{
			try
			{
				synchronized (client)
